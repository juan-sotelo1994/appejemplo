...
import 'package:appejemplo/widgets/login/verificacion.dart'; // <-- NUEVO
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const Text(
                    "Por favor ingrese su correo electrónico y le enviaremos un código para verificar su identidad.",
        ...
        Text.rich(
          TextSpan(
            ...
            style: Theme.of(context).textTheme.bodyMedium!.copyWith(
              color: Theme.of(
                context,
              ).textTheme.bodyLarge!.color!.withAlpha((0.64 * 255).toInt()),
            ),
            children: [
              TextSpan(
                text: "Regístrate",
